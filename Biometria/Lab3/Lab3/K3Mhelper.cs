...
namespace Lab3
{
    public class K3Mhelper
    {
        public static int[] deletionTable = new int[]{3,5,7,12,13,14,15,20,21,22,23,28,29,30,
        ...
        public static int[][] Mask = new int[][]
        {
            new int[] { 128, 1, 2 },
            new int[] { 64, 0, 4 },
            new int[] { 32, 16, 8 }
        ...
        public static int[] Apixel = new int[]
        {
